...
DATA testMOD;
	...
	"GBLABELS" "SUMMARY" "SUMMARYB2" "YEARLYFP" "CUMULMA" "FLEMING" "GALBRAIT" "RISKDIFF" 
		...
		"PVALRND" "NUMERIC" "GFIRST2"	"GLAST2" "GLAST" "CINDEX2" "LAB_TOX"
		"INPUT_UNIT"
					  "MV_GEN"
					  "CONVERT_UNIT"
					  "INPUT_NORMALS"
					  ...
					  "LABLIST_GEN"
					  "COMPUTE_CTC_GRADE"
					  "DETECT_PROBLEMS" "GRAYTEST" "PEPEMORI" "FINEANDGRAY"
	) then do;
			sas8='Y';
			CURRENT=USE;
	...
	"TABLES2"	"TESTF2" "BRYADAY" "CIPLOT" "QOL_COMP_V" "CINDEX2" "INPUT_UNIT"
	...
	"PEPEMORI" "FINEANDGRAY") then valid='Y'; 
...
DATA ML.macrolist2012;
	...
	"TABLES2"	"TESTF2" "CINDEX2" "LAB_TOX" "WATERFALL" "GRAYTEST" "PEPEMORI" "FINEANDGRAY"
...
data Processed;
	...
	if documentation="link" then do;
		** META ANALYSIS**;
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\META ANALYSIS\ALLFIXED2 Documentation 1.2.doc'>link</A>";
	    if macro1="FOREST2" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\META ANALYSIS\FOREST2 Documentation 1.1.doc'>link</A>";
		...
		** G MACROS**;
	    ...
	    if macro1="PVAL" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\GMACROS\PVAL Documentation 2.0.docx'>link</A>";
	    if macro1="PVALRND" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\GMACROS\PVALRND Documentation 2.0.docx'>link</A>";
		...
		** QOL**;
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\QOL\QoL_comp_V Documentation 1.1.doc'>link1</A>  <A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\QOL\QoL_comp_V macro_JRA_26_01_2009.ppt'>link2</A>";
		...
		** SURVIVAL ANALYSIS**;
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\CIPLOT Documentation - 3.0.docx'>link</A>";
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\CINDEX2 Documentation 1.0.doc'>link</A>";
	    if macro1="GRAYTEST" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\GRAYTEST Documentation 1.0.docx'>link</A>";
	    if macro1="PEPEMORI" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\PEPEMORI Documentation 1.0.docx'>link</A>";
	    if macro1="FINEANDGRAY" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\FINEANDGRAY Documentation 1.0.docx'>link</A>";

		** LABTOX**;
	    if macro1="LAB_TOX" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\LABTOX\How to use LAB_TOX macros v1.3.docx'>link1</A>  <A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\LABTOX\MACRO LABTOX JRA v3.ppt'>link2</A>";
		** WATERFALL**;
	    if macro1="WATERFALL" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\GMACROS\WATERFALL Documentation 1.0.docx'>link</A>";
