...
DATA testMOD;
	...
	"PEPEMORI" "FINEANDGRAY" "HAZARDPLOT" "INFERENCE2") then valid='Y'; 
	...
	"TABLES2"	"TESTF2" "CIPLOT2" "CINDEX2" "INFERENCE2"
	) then add='JRA';
...
data Processed;
	...
	if documentation="link" then do;
		...
		** SURVIVAL ANALYSIS**;
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\CIPLOT2 Documentation - 1.0.docx'>link</A>";
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\GRAYTEST Documentation 1.1.docx'>link</A>";
	    if macro1="PEPEMORI" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\PEPEMORI Documentation 1.1.docx'>link</A>";
	    if macro1="FINEANDGRAY" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\FINEANDGRAY Documentation 2.0.docx'>link</A>";
	    if macro1="INFERENCE2" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\INFERENCE2 Documentation 1.0.doc'>link</A>";
		...
		** HAZARDPLOT**;
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\SAS Macros Documentation\SURVIVAL ANALYSIS\HAZARDPLOT Documentation 1.0.docx'>link</A>";
