...
data Processed;
	...
	if documentation="link" then do;
		** META ANALYSIS**;
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\7. SAS and R\SAS Macros Documentation\META ANALYSIS\ALLFIXED2 Documentation 1.2.doc'>link</A>";
	    if macro1="FOREST2" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\7. SAS and R\SAS Macros Documentation\META ANALYSIS\FOREST2 Documentation 1.1.doc'>link</A>";
		...
		** SURVIVAL ANALYSIS**;
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\7. SAS and R\SAS Macros Documentation\SURVIVAL ANALYSIS\CIPLOT2 Documentation - 1.0.docx'>link</A>";
		...
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\7. SAS and R\SAS Macros Documentation\SURVIVAL ANALYSIS\GRAYTEST Documentation 1.1.docx'>link</A>";
	    if macro1="PEPEMORI" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\7. SAS and R\SAS Macros Documentation\SURVIVAL ANALYSIS\PEPEMORI Documentation 1.1.docx'>link</A>";
	    if macro1="FINEANDGRAY" then
		documentation="<A href='\\elvis\Pccommon\UNIT\Stat\7. SAS and R\SAS Macros Documentation\SURVIVAL ANALYSIS\FINEANDGRAY Documentation 2.0.docx'>link</A>";
