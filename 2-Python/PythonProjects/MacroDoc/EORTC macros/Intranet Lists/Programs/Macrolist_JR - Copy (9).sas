...
DATA testMOD;
	...
	if MACRO1 in ("AE_TABLE" "ALLFIXED2"	"ALLFIXEDB2"	"CLEAN_TABLE"	"FOREST2"	"FORESTB2"	
	...
	if MACRO1 in ("AE_TABLE") then add="GIS";
...
DATA ML.macrolist2014;
	...
	"PHREGTEMPLATE" "PRED_FACT"	"PRED_FACT_SUMMARY" "PRED_FACT_FOREST" "PREDICT_EVENTS" "TABLES3" "AE_TABLE"
