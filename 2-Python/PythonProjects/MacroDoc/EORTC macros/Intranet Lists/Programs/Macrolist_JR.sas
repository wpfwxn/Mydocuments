...
%LET Path = C:\Users\hazobou\PythonProjects\MacroDoc\EORTC macros\Intranet Lists\;
%INCLUDE "&Path.Programs\Setup.sas";

* DATAFILE= "K:\SAS\EORTC macros\Intranet Lists\Data\listMACROS.csv" ;

PROC IMPORT OUT= WORK.LIST 
            DATAFILE= "&Path.Data\listMACROS.csv" 
            DBMS=CSV REPLACE;
     GETNAMES=YES;
     DATAROW=2; 
RUN;
...
DATA ML.macrolist2017;
	...
	"PHREGTEMPLATE" "PRED_FACT"	"PRED_FACT_SUMMARY" "PRED_FACT_FOREST" "PREDICT_EVENTS" "TABLES3"
...
data _NULL_;
set ML.macrolist2014;
if MACRO1="QOL_SCORES" then call symput('modscore',compress(datemodif));
...
proc template;                                                                
   define style mystyle / store=sasuser.templat;                                               
      ...
      CLASS fonts /                                                         
       ...
       CLASS TitlesAndFooters from Container /                               
...
options pageno=1;
ods html file="C:\Users\hazobou\PythonProjects\MacroDoc\EORTC macros\Intranet Lists\Output\CurrentMacros.htm" style=Mystyle;
...
options pageno=1;
ods html file="C:\Users\hazobou\PythonProjects\MacroDoc\EORTC macros\Intranet Lists\Output\CurrentMacrosByCategory.htm" style=mystyle;
...
options pageno=1;
ods html file="C:\Users\hazobou\PythonProjects\MacroDoc\EORTC macros\Intranet Lists\Output\PastMacros.htm" style=mystyle;
